...
namespace SchoolEF
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<RetrieveClassesForStudent_Detailed_Result> RetrieveClassesForStudent_Detailed(Nullable<int> userId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RetrieveClassesForStudent_Detailed_Result>("RetrieveClassesForStudent_Detailed", userIdParameter);
        }
    }
}
